...
{
    public class SmartCharacter : ICharacter
    {
        public CharacterType CharacterType => CharacterType.Smart;
        ...
        {
            //Debug.Log($"Smart got damage={value} / Health{Health}");
            Health -= value;
            _view.TakeDamageView();
