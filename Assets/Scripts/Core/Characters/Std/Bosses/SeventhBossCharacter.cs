...
{
    public class SeventhBossCharacter : ICharacter
    {
        public CharacterType CharacterType => CharacterType.SeventhBossCharacter;
        ...
        {
            if (Vector3.Distance(CurrentTarget.View.transform.position, View.transform.position) < 1.5f)
            {
        ...
        private List<ICharacter> _currentTargets;
